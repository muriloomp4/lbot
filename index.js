...
const { help } = require('./leal/lealh')
const {help1} = require('./leal/help1')
const {help2} = require('./leal/help2')
const {help3} = require('./leal/help3')
const {help4} = require('./leal/help4')
const {help5} = require('./leal/help5')
const {help6} = require('./leal/help6')
const {help7} = require('./leal/help7')
const {help8} = require('./leal/help8')
...
async function starts() {
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			mess = {
					wait: '[❗️]*AGUARDE*, CASO O LEAL NÃO RESPONDA, TENTE NOVAMENTE',
					success: '️❬ ✔ ❭ Sucesso 🖤',
				...
				only: {
					...
					mod: '[❗] ESTE PEDIDO É ESPECÍFICO PARA USUARIO MOD LEAL BOT*',
					benned: 'Você para a banda, por favor, contate o proprietário para abrir sua banda',
					ownerG: '[❗] Este é um recurso especial para meu dono ❌',
					ownerB: '[❗] Este é um recurso especial para meu dono ❌',
					userB: `──「 LISTA 」──\nOlá Kak !\nDesculpe, irmã. Você não está registrado como amigo de LEAL. Registre-se para fazer amizade com o bot Leal por meio, \n\nCommand : ${prefix}daftar nama|idade\nExemplo : ${prefix}daftar Leal|17\n\n──「Leal BOT 」──`,
			...
			const ownerNumber = ["554791757651@s.whatsapp.net"] // replace this with your number
			const mod = [ownerNumber,"554791757651@s.whatsapp.net"]//ubah nomor lo
			const adminbotnumber = ["554791757651@s.whatsapp.net"]//ubah nomor lo
			const frendsowner = ["554791757651@s.whatsapp.net"]//ubah nomor lo
			const premium = ["555597294998@s.whatsapp.net","554791757651@s.whatsapp.net","558197995414@s.whatsapp.net","555596350424@s.whatsapp.net","555496222190@s.whatsapp.net","553388658467@s.whatsapp.net","5521965204100@s.whatsapp.net"] 
...
if (messagesC.includes("V6")){
			...
			client.updatePresence(from, Presence.composing)
			reply("*[MEU DONO🤠]* wa.me/+554791757651  *[MEU CRIADOR🤖]* Wa.me/+555597294998")
...
if (messagesC.includes("opa")){
	...
	if (messagesC.includes("barões")){
			...
			switch(command) {
				case 'help':
				case 'menu':
client.sendMessage(from, help(pushname,  prefix) , text, {quoted: mek, quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "OLÁ, ${pushname}, APROVEITE O LEAL BOT", 'jpegThumbnail': fs.readFileSync('muriloo/bot/imgbot.webp')}}}})					
break
				case 'help1':
				case 'menu1':
					client.sendMessage(from, help1(pushname,  prefix), text)
					break
				case 'help2':
				case 'menu2':
					client.sendMessage(from, help2(pushname,  prefix), text)
					break
				case 'help3':
				case 'menu3':
					client.sendMessage(from, help3(pushname,  prefix), text)
					break
				case 'help4':
				case 'menu4':
					client.sendMessage(from, help4(pushname,  prefix), text)
					break
				case 'help5':
				case 'menu5':
					client.sendMessage(from, help5(pushname,  prefix), text)
					break
				case 'help6':
				case 'menu6':
					client.sendMessage(from, help6(pushname,  prefix), text)
					break
				case 'help7':
				case 'menu7':
					client.sendMessage(from, help7(pushname,  prefix), text)
					break
				case 'help8':
				case 'menu8':
					client.sendMessage(from, help8(pushname,  prefix), text)
					break
					case 'kiss':
				    try {    
...
break
				...
				case 'wibu':
                   ...
                   break
					case 'totaluser':
					if (!isOwner) return reply(mess.only.ownerB)    
					teks = `\`\`\`╭────*「 *TOTAL DE USUÁRIOS Leal BOT 👑* 」\n\`\`\``
					no = 0
...
// recursos anime, random Leal domina vida
          ...
          reply('Espere..')
				...
				if (!isGroup) return reply(mess.only.group)
					...
					break
			    case 'owner':
                    client.sendMessage(from, {displayname: "KAUA SHELBY", vcard: vcard}, MessageType.contact, { quoted: mek})
				...
				case 'neko':
					...
					client.sendMessage(from, tod, image, { quoted: mek, caption: '*╭────*「 *ADMINBOT Leal ✨* 」\n*│+ wa.me/555597294998*╰──────*「 *Leal* 」*────*\n\n*_SE QUER SER ADMIN DO Leal BOT_*\n*_Tipo /iklan_*' })
					break
				case 'iklan':
